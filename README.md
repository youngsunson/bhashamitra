...
1. **Clone the repository**
   ```bash
   git clone https://github.com/youngsunson/bhashamitra.git
   cd bhashamitra
   ```
...
- Make it available at: `https://youngsunson.github.io/bhashamitra/`
...
For issues and support, please visit: [GitHub Issues](https://github.com/youngsunson/bhashamitra/issues)
